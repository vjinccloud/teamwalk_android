...
//                            + " csaName: "+CELEBRUSCSA_csaName
//                            + " collectionUrl: "+CELEBRUSCSA_collectionUrl
//                            + " appName: "+CELEBRUSCSA_appName, Toast.LENGTH_SHORT).show();
        }catch (Exception e){}
    }
...
//        Toast.makeText(application, "CelebrusCSAUtil "+ "instrument: "+application.getClass().getName(), Toast.LENGTH_SHORT).show();
    }
...
//        Toast.makeText(activity, "CelebrusCSAUtil "+ "sessionSharing: "+activity.getClass().getName()+ " domains:"+ domains, Toast.LENGTH_SHORT).show();
    }
